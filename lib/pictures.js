...
async function callModel(model, picture, { maxTokens, timeoutMs }) {
    ...
    res = await fetch(OPENROUTER_URL(), {
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          { role: 'user', content: [
            { type: 'text', text: 'Read the transcript lines in this picture.' },
  ...
  const answer = readPictureAnswer(content);
